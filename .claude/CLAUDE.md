...
- Firestore security rules live in `firestore.rules`. Changes to that file must be deployed to take effect — local edits alone do nothing.
  - Deploy to dev: `yarn deploy:dev`
  - Deploy to web/prod: `yarn deploy:web`
...
Last indexed: 2026-05-17 (commit f4ae770)

### Entry Points

- `i18n/index.ts`
- `app.json`
- `app/(app)/piece/[id]/index.tsx`
- `app/(app)/piece/[id]/section/index.tsx`
- `app/(app)/technique/[id]/index.tsx`
- `app/index.tsx`
...
| -------------------------------- | ----------- | ----------- | ----- |
| `app/(app)/(tabs)/technique.tsx` | 98.3th %ile | 2           | senth |
| `app/(app)/(tabs)/overview.tsx`  | 96.7th %ile | 11          | senth |
| `app/(app)/(tabs)/piece.tsx`     | 95.0th %ile | 2           | senth |
| `app/(auth)/login.tsx`           | 93.3th %ile | 4           | senth |
| `app/(app)/piece/[id]/index.tsx` | 91.7th %ile | 1           | senth |
