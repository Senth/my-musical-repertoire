---
name: pianist-review
description: "Reviews a planned feature or a planned removal through the pianist personas, surfacing missed needs, pedagogical errors, pitfalls and improvements before the spec is written. Use from /new-feature, from /cleanup when a cleanup changes what a student sees, or when asking what real players and teachers would make of an existing feature. Not for code review or bug triage."
model: opus
